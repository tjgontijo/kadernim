...
Sistema de billing desacoplado para o Kadernim SaaS, permitindo cobrancas recorrentes via checkout transparente. A arquitetura suporta multiplos provedores de pagamento (Asaas para BRL, Stripe para USD/EUR no futuro) atraves de um padrao Provider/Adapter.
