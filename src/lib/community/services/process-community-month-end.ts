...
interface CommunityMonthEndResult {
  deletedZeroVotes: number
  selectedTop10: number
  survivors: number
  deletedLeftover: number
}

export async function processCommunityMonthEnd(): Promise<
  Result<{ month: string; result: CommunityMonthEndResult }, string>
> {
