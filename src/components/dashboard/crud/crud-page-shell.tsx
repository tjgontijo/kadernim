...
export function CrudPageShell({
    ...
    return (
        <section className="flex flex-col h-full overflow-hidden bg-background">
            <div className={cn("flex flex-col h-full min-h-0 w-full", !isMobile && "dashboard-page-container")}>
                {!isMobile && (
                    <>
                        {/* Synchronized Header */}
                        ...
                        <div className="flex flex-col gap-4 py-3 md:flex-row md:items-center md:justify-between border-b border-border/50 bg-muted/5">
                ...
                <div className="border-t border-border bg-background py-2 shrink-0 h-14 flex items-center">
