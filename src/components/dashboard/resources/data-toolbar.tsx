...
export function DataToolbar({
  ...
  if (children) {
    return (
      <div className={cn('flex flex-col gap-4 py-4 md:flex-row md:items-center px-6', className)}>
        {children}
      </div>
    )
  }
  ...
  return (
    <div className={cn('flex flex-col gap-4 py-3 md:flex-row md:items-center md:justify-between px-6', className)}>
