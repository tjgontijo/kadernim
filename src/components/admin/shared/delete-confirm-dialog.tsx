    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="max-w-[400px] p-0 overflow-hidden border-none shadow-2xl">
                ...
                <AlertDialogFooter className="p-6 bg-muted/30 gap-3 sm:gap-0">
                    <AlertDialogCancel className="h-11 font-bold rounded-xl border-muted-foreground/20 hover:bg-muted transition-all">
                        {cancelText}
                    </AlertDialogCancel>
                    <AlertDialogAction
                        onClick={(e) => {
                        ...
                        disabled={isLoading}
                        className={cn(
                            "h-11 font-bold rounded-xl shadow-lg transition-all",
                            variant === 'destructive'
