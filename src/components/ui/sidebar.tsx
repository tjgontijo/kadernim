...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-ink-mute px-3 py-4 text-[11px] font-semibold uppercase tracking-[0.12em] transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 [&>svg]:size-4 flex shrink-0 items-center outline-none [&>svg]:shrink-0",
        className
      )}
      {...props}
    />
