...
function Stats() {
  const items = [
    ...
    { value: '100%', label: 'Materiais em PDF para imprimir' },
        ...
        <div className="space-y-28 2xl:space-y-36">
            ...
            <div className="p-6 2xl:p-8 rounded-2xl border border-brand-1/15 bg-brand-1/5">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { task: 'Preparando materiais e atividades', time: '2h 00min' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 2xl:gap-20 items-center">
            <div>
              ...
              <p className="text-slate-400 text-base 2xl:text-lg leading-relaxed">
                Você abre o Kadernim, encontra o material na biblioteca, baixa o PDF e pronto. O domingo voltou a ser seu.
              </p>
              <button
                onClick={go}
...
───────────────────────────────────────────── */
const faqs = [
  { q: 'Mas eu já tenho uma rotina de preparação. Vale mudar?', a: 'Se a sua rotina custa 8 horas por semana, sim. Com a biblioteca pronta e organizada, o que hoje leva horas passa a levar minutos. A maioria das professoras sente a diferença já na primeira semana.' },
  { q: 'Os materiais são realmente prontos ou preciso adaptar muito?', a: 'Os materiais são criados especificamente para Ed. Infantil e Fundamental I, já formatados e prontos para imprimir em PDF.' },
          ...
          <div className="space-y-2 2xl:space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="rounded-xl border border-white/6 bg-white/[0.02] overflow-hidden">
                ...
                {open === i && (
                  <div
                    id={`faqc-variantc-faq-p-${i}`}
                    role="region"
                    aria-labelledby={`faqc-variantc-faq-${i}`}
