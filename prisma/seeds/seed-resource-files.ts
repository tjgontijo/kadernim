...
const FILES: ResourceFileSeedItem[] = [
  ...
  {
    externalId: 31566073,
    name: 'ATIVIDADES PORTUGUÊS - FOLHINHAS PARTE I - 1º AO 5º ANO',
  ...
  {
    externalId: 42313389,
    name: 'Avaliação GEOGRAPHY - 4º bimestre - 5º ano',
    url: 'https://drive.google.com/drive/folders/1OUlAFzm0auoNKqvxFEzWkzg7gT-a1MXP?usp=sharing',
  },
  {
    externalId: 42479572,
    name: 'Avaliação GEOGRAPHY 4º bimestre 4º ano',
  ...
  {
    externalId: 30200115,
    name: 'Folhinhas de conceitos de GEOGRAPHY para o 1º ao 5º ano',
