...
-- CreateIndex
CREATE INDEX "resource_subjectId_educationLevelId_idx" ON "resource"("subjectId", "educationLevelId");

-- CreateIndex
CREATE INDEX "resource_createdAt_idx" ON "resource"("createdAt" DESC);

-- CreateIndex
CREATE INDEX "resource_isFree_createdAt_idx" ON "resource"("isFree", "createdAt" DESC);
...
-- CreateIndex
CREATE INDEX "user_resource_access_userId_grantedAt_idx" ON "user_resource_access"("userId", "grantedAt" DESC);

-- CreateIndex
CREATE INDEX "user_resource_access_userId_isActive_expiresAt_idx" ON "user_resource_access"("userId", "isActive", "expiresAt");
